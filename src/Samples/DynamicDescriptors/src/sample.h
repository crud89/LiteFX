...
#else 
#  pragma message ("Dynamic Descriptors Sample: No supported surface platform detected.")
#endif
...
public:
	static StringView Name() noexcept { return "LiteFX Sample: Dynamic Descriptors"sv; }
...
private:
	...
	/// @brief The base index of the first instance. This value is set to the index of the first instance buffer in the global resource descriptor heap and later passed as a static offset to the
	/// `drawInstanced` call.
