...
#else 
#  pragma message ("Push Constants Sample: No supported surface platform detected.")
#endif
...
public:
	static StringView Name() noexcept { return "LiteFX Sample: DirectX 12 Push Constants"; }
