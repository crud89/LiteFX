...
public:
	static StringView Name() noexcept { return "LiteFX Sample: DirectX 12 Texturing"; }
...
private:
	...
	/// </summary>
	UniquePtr<DirectX12DescriptorSet> m_constantBindings, m_samplerBindings;
	...
	/// </summary>
	UniquePtr<IDirectX12Sampler> m_sampler;
