...
public:
	static StringView Name() noexcept { return "LiteFX Sample: DirectX 12 CBV arrays"; }
...
private:
	...
	/// </summary>
	UniquePtr<IDirectX12Buffer> m_cameraBuffer, m_cameraStagingBuffer, m_lightsBuffer;
