...
public:
	static String name() noexcept { return "LiteFX Sample: DirectX 12 CBV arrays"; }
...
private:
	...
	/// </summary>
	UniquePtr<IDirectX12ConstantBuffer> m_cameraBuffer, m_cameraStagingBuffer, m_lightsBuffer;
	...
	/// <summary>
	/// Stores the binding for the camera and lights buffer.
	/// </summary>
	UniquePtr<DirectX12DescriptorSet> m_staticBindings;
