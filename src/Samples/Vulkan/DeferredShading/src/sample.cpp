...
void SampleApp::initBuffers()
{
    ...
    m_viewPlaneVertexBuffer->transferFrom(m_device->transferQueue(), stagedVertices.get(), stagedVertices->getSize());
    ...
    m_viewPlaneIndexBuffer->transferFrom(m_device->transferQueue(), stagedIndices.get(), stagedIndices->getSize());
