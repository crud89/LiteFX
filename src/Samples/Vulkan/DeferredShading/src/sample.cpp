...
void SampleApp::createRenderPasses()
{
    m_geometryPass = m_device->buildRenderPass()
        .attachTarget(RenderTargetType::Color, Format::B8G8R8A8_UNORM, MultiSamplingLevel::x1, { 0.f, 0.f, 0.f, 0.f }, true)
    ...
    m_lightingPass = m_device->buildRenderPass()
        ...
        .attachTarget(RenderTargetType::Present, Format::B8G8R8A8_SRGB, MultiSamplingLevel::x1, { 0.f, 0.f, 0.f, 0.f }, true)
        .addPipeline()
            .defineLayout()
                .setShaderProgram()
