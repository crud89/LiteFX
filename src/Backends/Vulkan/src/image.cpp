...
{
	// TODO: We have to delay this, if we are currently in a defragmentation process. The best way to do this would be to add a reference to all currently 
	//       allocated resources before we begin a defragmentation pass. However, this would also mean we have to store a weak pointer to them in the 
	//       graphics factory.
