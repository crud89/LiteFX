...
bool DirectX12Image::move(SharedPtr<IDirectX12Image> image, D3D12MA::Allocation* to, const DirectX12CommandBuffer& commandBuffer) // NOLINT(performance-unnecessary-value-param)
{
