...
public:
    ...
    {
        static auto builder = [](WeakPtr<const DirectX12BottomLevelAccelerationStructureImpl> impl) -> std::generator<D3D12_RAYTRACING_GEOMETRY_DESC> {
...
void DirectX12BottomLevelAccelerationStructure::build(const DirectX12CommandBuffer& commandBuffer, const SharedPtr<const IDirectX12Buffer>& scratchBuffer, const SharedPtr<const IDirectX12Buffer>& buffer, UInt64 offset, UInt64 maxSize)
{
...
void DirectX12BottomLevelAccelerationStructure::update(const DirectX12CommandBuffer& commandBuffer, const SharedPtr<const IDirectX12Buffer>& scratchBuffer, const SharedPtr<const IDirectX12Buffer>& buffer, UInt64 offset, UInt64 maxSize)
{
    // Validate the state.
...
void DirectX12BottomLevelAccelerationStructure::copy(const DirectX12CommandBuffer& commandBuffer, DirectX12BottomLevelAccelerationStructure& destination, bool compress, const SharedPtr<const IDirectX12Buffer>& buffer, UInt64 offset, bool copyBuildInfo) const
{
    // Validate the state.
    if (m_impl->m_buffer == nullptr) [[unlikely]]
        throw RuntimeException("The acceleration structure must have been built before it can be updated.");
...
void DirectX12BottomLevelAccelerationStructure::doBuild(const ICommandBuffer& commandBuffer, const SharedPtr<const IBuffer>& scratchBuffer, const SharedPtr<const IBuffer>& buffer, UInt64 offset, UInt64 maxSize)
{
...
void DirectX12BottomLevelAccelerationStructure::doUpdate(const ICommandBuffer& commandBuffer, const SharedPtr<const IBuffer>& scratchBuffer, const SharedPtr<const IBuffer>& buffer, UInt64 offset, UInt64 maxSize)
{
...
void DirectX12BottomLevelAccelerationStructure::doCopy(const ICommandBuffer& commandBuffer, IBottomLevelAccelerationStructure& destination, bool compress, const SharedPtr<const IBuffer>& buffer, UInt64 offset, bool copyBuildInfo) const
{
