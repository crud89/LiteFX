...
void TestApp::onInit()
{
    ...
    auto startCallback = [this](DirectX12Backend* backend) {
        ...
        UniquePtr<DirectX12RenderPass> renderPass = _device->buildRenderPass("Opaque", 5)
        ...
        UniquePtr<DirectX12RenderPass> deferredPass = _device->buildRenderPass("Deferred", 1)
