...
void TestApp::onInit()
{
    ...
    auto startCallback = [this](DirectX12Backend* backend) {
        ...
        SharedPtr<DirectX12RenderPass> renderPass = _device->buildRenderPass("Opaque", 5)
        ...
        SharedPtr<DirectX12RenderPass> deferredPass = _device->buildRenderPass("Deferred", 1)
