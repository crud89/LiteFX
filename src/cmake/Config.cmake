...
# For the version 0.x series, compatibility is only guaranteed between minor versions.
IF(PROJECT_VERSION_MAJOR EQUAL 0)
    SET(_litefx_compatibility SameMinorVersion)
ELSE()
    SET(_litefx_compatibility SameMajorVersion)
ENDIF()

WRITE_BASIC_PACKAGE_VERSION_FILE("${CMAKE_CURRENT_BINARY_DIR}/LiteFXConfigVersion.cmake"
    COMPATIBILITY ${_litefx_compatibility})

INSTALL(FILES "${CMAKE_CURRENT_BINARY_DIR}/LiteFXConfig.cmake" "${CMAKE_CURRENT_BINARY_DIR}/LiteFXConfigVersion.cmake" 
    "${CMAKE_CURRENT_LIST_DIR}/Assets.cmake" "${CMAKE_CURRENT_LIST_DIR}/Shaders.cmake" "${CMAKE_CURRENT_LIST_DIR}/Runtime.cmake"
