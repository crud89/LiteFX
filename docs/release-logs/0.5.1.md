...
- Improved memory management.
  ...
  - Implement support for resource defragmentation. (See [PR #192](https://github.com/crud89/LiteFX/pull/192) and [PR #195](https://github.com/crud89/LiteFX/pull/195))
  - Implement support for resource aliasing. (See [PR #193](https://github.com/crud89/LiteFX/pull/193))
...
- It is now possible to provide custom allocators for frame buffer images, which enables fixed-size or aliased render targets. (See [PR #193](https://github.com/crud89/LiteFX/pull/193))
- Implemented support for view instancing/multi-view rendering. (See [PR #194](https://github.com/crud89/LiteFX/pull/194))
