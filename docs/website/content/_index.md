...
<h1 class="text-center text-light">Designed to make Modern Graphics APIs accessible.</h1>
...
<h1 class="text-center text-light">With support for state of the art rendering techniques.</h1>

<div class="feature-row" style="display: flex; margin: 2em 0em;">
...
<div style="margin: 1em; color: white; width: 60%"> 
<h4 class="h3">Indirect Rendering</h4>
